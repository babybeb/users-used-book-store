...
public enum Second {
    ...
    /* 서울 */
    강남구, 강동구, 강북구, 관악구, 광진구, 구로구, 금천구, 노원구, 도봉구, 동대문구, 동작구,
    ...
    /* 충남 */
    계룡시, 공주시, 금산군, 논산시, 당진시, 보령시, 부여군, 서산시, 서천군, 아산시, 예산군, 천안시,
    청양군, 태안군, 홍성군,
    ...
    /* 경남 */
    거제시, 거창군, 고성군2, 김해시, 남해군, 밀양시, 사천시, 산청군, 양산시, 의령군, 진주시, 창녕군,
    ...
    /* 전북 */
    고창군, 군산시, 김제시, 남원시, 무주군, 부안군, 순창군, 완주군, 익산시, 임실군, 장수군, 전주시,
    정읍시, 진안군,
    ...
    /* 지명이 겹치는 곳 */
    중구, // 서울, 인천, 대전, 부산, 울산, 대구
    남구, // 부산, 울산, 대구, 광주
    동구, // 인천, 대전, 부산, 울산, 대구, 광주
    북구, // 부산, 울산, 대구, 광주
    서구, // 인천, 대전, 부산, 대구, 광주
    강서구 // 서울, 부산
}
